	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#confirmacion_guardar").click(function(){
				...
				datos.append('bandera', 'vision');
		        datos.append('id', '1');
		        datos.append('informacion', $("#vision").val());
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<?php foreach(buscar_informacion_empresa() as $informacion){ ?>
					<textarea id="vision" class="form-control textarea " rows="15" readonly><?php echo $informacion['vision']; ?></textarea>
				<?php } ?>
			</div>
		</div>
		<div class="row">
